defmodule MyappWeb.Router do
  ...
  scope "/", MyappWeb do
    ...
    scope "/recipes" do
      ...
      live "/drill-down-navigation", DrillDownNavigationLive,
        metadata: %{
      ...
      live "/hub-and-spoke-navigation", HubAndSpokeNavigationLive,
        metadata: %{
      ...
      live "/media-overview", MediaOverviewLive,
        metadata: %{
      ...
      live "/message-thread", MessageThreadLive,
        metadata: %{
      ...
      live "/playback-bar", PlaybackBarLive,
        metadata: %{
          title: "Playback Bar",
          icon: "playpause.fill",
      ...
      live "/pyramid-navigation", PyramidNavigationLive,
        metadata: %{
      ...
      live "/scroll-automation", ScrollAutomationLive,
        metadata: %{
      ...
      live "/sectioned-grid", SectionedGridLive,
        metadata: %{
